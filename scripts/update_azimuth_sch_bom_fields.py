...
DESCS: dict[tuple[str, str], str] = {
    ...
    ("R2", "220K"): "Battery divider low side: VBAT/2 to IO2 for ADC (with R1)",
    ...
    ("R14", "10k"): "BNO086 ENV_SCL pull-up to 3V3",
    ...
    ("R6", "680R"): "RGB LED blue cathode resistor (IO3): lower current for brightness balance",
    ("PWR1", "K3-1280S-K1"): "Slide switch: battery disconnect / power control",
    ("R8", "150R"): "RGB LED green cathode resistor (IO1)",
    ("C10", "0.1uf"): "3V3 / LDO output HF decoupling",
    ("C3", "100nF"): "BNO086 VDD local decoupling at IC",
    ...
    ("R1", "220K"): "Battery divider high side: VBAT to ADC tap (with R2)",
    ...
    ("R15", "10k"): "BNO086 ENV_SDA pull-up to 3V3",
    ("R7", "150R"): "RGB LED red cathode resistor (IO0)",
